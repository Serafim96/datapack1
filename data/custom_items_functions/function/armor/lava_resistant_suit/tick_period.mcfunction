...
execute as @a[nbt={equipment:{head:{components:{"minecraft:custom_data":{Tags:["lava_resistant_suit"]}}},chest:{components:{"minecraft:custom_data":{Tags:["lava_resistant_suit"]}}},legs:{components:{"minecraft:custom_data":{Tags:["lava_resistant_suit"]}}},feet:{components:{"minecraft:custom_data":{Tags:["lava_resistant_suit"]}}}}}] at @s if block ~ ~ ~ lava run function custom_items_functions:armor/lava_resistant_suit/suit_impact

# Когда вылезли из лавы -- огонь какое-то время бьет, нужно ждать, пока костюм остынет
execute as @a[nbt={equipment:{head:{components:{"minecraft:custom_data":{Tags:["lava_resistant_suit"]}}},chest:{components:{"minecraft:custom_data":{Tags:["lava_resistant_suit"]}}},legs:{components:{"minecraft:custom_data":{Tags:["lava_resistant_suit"]}}},feet:{components:{"minecraft:custom_data":{Tags:["lava_resistant_suit"]}}}}}] at @s unless block ~ ~ ~ lava unless entity @s[nbt={Fire:-20s}] run function custom_items_functions:armor/lava_resistant_suit/suit_impact
