$execute unless block ~ ~ ~ water if biome ~ ~ ~ #overworld_extension:pripyat/radiation_levels/1 run return run function custom_items_functions:science/geiger_counter/reuse/modify_level {hand:$(hand),level:10}
$execute unless block ~ ~ ~ water if biome ~ ~ ~ #overworld_extension:pripyat/radiation_levels/2 run return run function custom_items_functions:science/geiger_counter/reuse/modify_level {hand:$(hand),level:20}
$execute unless block ~ ~ ~ water if biome ~ ~ ~ #overworld_extension:pripyat/radiation_levels/3 run return run function custom_items_functions:science/geiger_counter/reuse/modify_level {hand:$(hand),level:30}
$execute unless block ~ ~ ~ water if biome ~ ~ ~ #overworld_extension:pripyat/radiation_levels/4 run return run function custom_items_functions:science/geiger_counter/reuse/modify_level {hand:$(hand),level:40}
$execute unless block ~ ~ ~ water if biome ~ ~ ~ #overworld_extension:pripyat/radiation_levels/5 run return run function custom_items_functions:science/geiger_counter/reuse/modify_level {hand:$(hand),level:50}
$execute unless block ~ ~ ~ water if biome ~ ~ ~ #overworld_extension:pripyat/radiation_levels/6 run return run function custom_items_functions:science/geiger_counter/reuse/modify_level {hand:$(hand),level:60}
$execute unless block ~ ~ ~ water if biome ~ ~ ~ #overworld_extension:pripyat/radiation_levels/7 run return run function custom_items_functions:science/geiger_counter/reuse/modify_level {hand:$(hand),level:70}
