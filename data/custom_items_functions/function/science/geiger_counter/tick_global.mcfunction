...
execute as @e[predicate=custom_items_functions:science/geiger_counter/holds/anyhand] at @s run function custom_items_functions:science/geiger_counter/hand_fork
