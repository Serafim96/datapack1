...
execute in overworld run fill -4859 0 5625 -4857 0 5627 air
execute in overworld as @e[tag=!lift_exclude,x=-4859,dx=2,z=5625,dz=2,y=0,dy=0.1] at @s run tp @s ~ 0 ~ ~ ~
