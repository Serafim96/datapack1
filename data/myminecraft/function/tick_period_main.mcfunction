...
function myminecraft:tick_additions/pre_tick_period
...
function custom_items_functions:tick_period_main
# function thepa:loop
# function custom_block:main
# function custom_weapon:tick_global
# function custom_crafting:tick_period_main
# function portal_guns:main
# function pochta_russia:tick_global

# Тик Верхний мир
execute in overworld run function overworld_extension:tick_period_main

# Отдельные измерения
# execute in dev_dimension:dev_dimension run function dev_dimension:tick_global
function custom_dimension:tick_period_main
...
function village_artem:tick_period_main
