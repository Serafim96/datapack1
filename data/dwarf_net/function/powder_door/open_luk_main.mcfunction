...
schedule function dwarf_net:powder_door/open_luk2 10


#Первые поршни
schedule function dwarf_net:powder_door/open_luk25 65
schedule function dwarf_net:powder_door/open_luk3 70
schedule function dwarf_net:powder_door/open_luk4 80

#Отключение создания песка
function dwarf_net:powder_door/end_rise
