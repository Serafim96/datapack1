...
#shopping center
execute as @e[type=player,x=-16,dx=1,y=-57,dy=3,z=84] at @s run tp @s 5775 76 4568 ~ ~
particle minecraft:reverse_portal -15.99 -55.01 84 0.5 0.8 0.1 0.04 2

#the end portal
#execute as @e[type=player,x=4,y=-57,dy=3,z=104,dz=1] at @s in minecraft:the_end run tp @s 40 58 14.99
...
#aquarium
execute as @e[type=player,x=-17,dx=1,y=-57,dy=3,z=125] at @s run tp @s 1420 73 298.99 ~270 ~
