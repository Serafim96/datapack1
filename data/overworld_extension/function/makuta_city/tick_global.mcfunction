...
execute as @e[type=minecart] at @s if biome ~ ~ ~ #overworld_extension:makuta_city_zone if block ~ ~-0.01 ~ powered_rail[powered=true] unless entity @a[distance=..2] run data modify entity @s Motion set value [0.0d,0.0d,0.0d] 
