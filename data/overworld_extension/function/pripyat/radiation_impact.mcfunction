...
execute if score @s RadiationLevel matches 43680.. store result score @s RadiationImpactTimer run random value 20..30 minecraft:archaeology/desert_pyramide
