...
execute in overworld run fill -4049 77 5438 -4047 77 5440 air
execute in overworld as @e[tag=!lift_exclude,x=-4049,dx=2,z=5438,dz=2,y=77,dy=0.1] at @s run tp @s ~ 77 ~ ~ ~
