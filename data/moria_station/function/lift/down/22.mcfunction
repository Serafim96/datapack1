...
execute in overworld run fill -4049 68 5438 -4047 68 5440 air
execute in overworld as @e[tag=!lift_exclude,x=-4049,dx=2,z=5438,dz=2,y=68,dy=0.1] at @s run tp @s ~ 68 ~ ~ ~
