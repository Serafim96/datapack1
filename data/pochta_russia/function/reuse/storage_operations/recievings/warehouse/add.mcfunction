$data modify storage $(storage_name) $(dep_name).warehouse append value {sender_id:$(sender_id),sender_name:$(sender_name),sender_name_txt:"$(sender_name_txt)",items:$(items)}
