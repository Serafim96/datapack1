...
data modify entity @e[x=-678,dx=6,y=254,dy=6,z=2607,dz=6,limit=1,sort=nearest,type=ender_dragon] Pos set value [-674.08d,256.79d,2611.00d] 
...
data modify entity @e[x=-678,dx=6,y=254,dy=6,z=2607,dz=6,limit=1,sort=nearest,type=ender_dragon] Health set value 200f