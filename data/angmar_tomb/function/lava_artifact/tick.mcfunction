...
execute if data storage angmar_tomb:lava_artifact_door_state {State:1} if entity @a[x=521,dx=25,y=49,dy=1,z=-1043,dz=9,gamemode=!spectator] run data modify storage angmar_tomb:lava_artifact_door_state State set value 2

#Если состояние "Открыто, вошли", и при этом все вышли из пещеры, то ставим состояние "Закрыто"
execute if data storage angmar_tomb:lava_artifact_door_state {State:2} unless entity @a[x=521,dx=25,y=49,dy=1,z=-1043,dz=9,gamemode=!spectator] run function angmar_tomb:lava_artifact/close_entrance

#Если состояние "Открыто, но не вошли", и при этом все вышли из комнаты, но не входили, то ставим состояние "Закрыто"
execute if data storage angmar_tomb:lava_artifact_door_state {State:1} unless entity @a[x=547,dx=19,y=48,dy=7,z=-1047,dz=17,gamemode=!spectator] run function angmar_tomb:lava_artifact/close_entrance
