...
execute in minecraft:the_nether if data storage angmar_tomb:main_door_state {isSound3Played:0} run playsound minecraft:block.stone.place block @a 603.5 37.5 -1067.5
...
execute if data storage minecraft:global {SucsessFunctionCall:1} run data modify storage angmar_tomb:main_door_state isSound3Played set value 0
execute in minecraft:the_nether if data storage angmar_tomb:main_door_state {isSound3Played:0} run playsound minecraft:block.stone.place block @a 601.5 41.5 -1067.5
data modify storage angmar_tomb:main_door_state isSound3Played set value 1
