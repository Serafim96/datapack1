...
execute if data storage angmar_tomb:main_door_state {isSound4Played:0} run playsound minecraft:block.stone.place block @a 602.5 41.5 -1067.5
...
execute if data storage minecraft:global {SucsessFunctionCall:1} run data modify storage angmar_tomb:main_door_state isSound4Played set value 0
execute if data storage angmar_tomb:main_door_state {isSound4Played:0} run playsound minecraft:block.stone.place block @a 602.5 37.5 -1067.5
data modify storage angmar_tomb:main_door_state isSound4Played set value 1
