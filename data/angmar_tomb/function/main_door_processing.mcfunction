...
execute in minecraft:the_nether unless entity @a[gamemode=!spectator,x=594,dx=16,y=37,dy=5,z=-1081,dz=16] if data storage angmar_tomb:main_door_state {State:2} run data modify storage angmar_tomb:main_door_state State set value 1


#Если игрок выходит, то открываем боновые двери
#Правая
execute in minecraft:the_nether if entity @a[gamemode=!spectator,x=575,dx=5,y=32,dy=12,z=-1091,dz=14] run function angmar_tomb:r_open_entrance
execute in minecraft:the_nether unless entity @a[gamemode=!spectator,x=575,dx=5,y=32,dy=12,z=-1091,dz=14] run function angmar_tomb:r_close_entrance

execute in minecraft:the_nether if entity @a[gamemode=!spectator,x=623,dx=5,y=32,dy=12,z=-1091,dz=14] run function angmar_tomb:l_open_entrance
execute in minecraft:the_nether unless entity @a[gamemode=!spectator,x=623,dx=5,y=32,dy=12,z=-1091,dz=14] run function angmar_tomb:l_close_entrance
#/fill 623 32 -1090 
#      628 44 -1077
