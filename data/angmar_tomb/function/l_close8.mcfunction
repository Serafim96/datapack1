...
execute in minecraft:the_nether if data storage angmar_tomb:main_door_state {lisSound8Played:0} run playsound minecraft:block.stone.place block @a 625.5 35.5 -1090.5
...
execute if data storage minecraft:global {SucsessFunctionCall:1} run data modify storage angmar_tomb:main_door_state lisSound8Played set value 0
execute in minecraft:the_nether if data storage angmar_tomb:main_door_state {lisSound8Played:0} run playsound minecraft:block.stone.place block @a 627.5 33.5 -1090.5
data modify storage angmar_tomb:main_door_state lisSound8Played set value 1
