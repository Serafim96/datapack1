...
scoreboard players add @a[x=654,dx=1,y=46,dy=0.1,z=-1039,dz=1,scores={angmar_tomb_underwater_buff_achieved=0}] angmar_tomb_underwater_buff_progress 1
...
execute if entity @a[x=654,dx=1,y=46,dy=0.1,z=-1039,dz=1,scores={angmar_tomb_underwater_buff_achieved=0}] store result bossbar minecraft:agmar_tomb_underwater_buff value run scoreboard players add AngmarTombTestUser angmar_tomb_underwater_buff_progress 1
...
execute unless entity @a[x=654,dx=1,y=46,dy=0.1,z=-1039,dz=1] as @a[x=654,dx=1,y=48,dy=0,z=-1039,dz=1,scores={angmar_tomb_underwater_buff_progress=0..509}] at @s run function angmar_tomb:underwater_buff/reset_scoreboard
