...
# [WAS] execute if entity @p[gamemode=survival] run kill @e[type=item,distance=..1,limit=1,sort=nearest,nbt={Item:{id:"minecraft:green_stained_glass"}}]
...
execute if entity @p[gamemode=survival] run kill @e[distance=..1,limit=1,sort=nearest,nbt={Item:{id:"minecraft:green_stained_glass"}},type=item]
kill @s