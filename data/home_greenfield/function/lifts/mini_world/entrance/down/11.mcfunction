...
execute in overworld run fill 6165 51 2086 6168 51 2089 air
execute in overworld as @e[tag=!lift_exclude,x=6165,dx=3,z=2086,dz=3,y=51,dy=0.1] at @s run tp @s ~ 51 ~ ~ ~
