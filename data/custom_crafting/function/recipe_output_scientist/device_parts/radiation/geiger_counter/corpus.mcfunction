...
execute as @s[tag=wasd.north] run summon item ~ ~-0.7 ~-0.7 {Motion:[0.0,0.1,-0.15],Item:{id:"minecraft:clock",count:1,components:{"minecraft:item_model":"custom/science/geiger_counter/parts/corpus","minecraft:custom_model_data":{strings:["corpus"]},"minecraft:custom_data":{Tags:["geiger_counter_corpus"]},"minecraft:custom_name":{"color":"#F1AF15","italic":false,"text":"Корпус счётчика Гейгера"}}}}
execute as @s[tag=wasd.south] run summon item ~ ~-0.7 ~0.7 {Motion:[0.0,0.1,0.15],Item:{id:"minecraft:clock",count:1,components:{"minecraft:item_model":"custom/science/geiger_counter/parts/corpus","minecraft:custom_model_data":{strings:["corpus"]},"minecraft:custom_data":{Tags:["geiger_counter_corpus"]},"minecraft:custom_name":{"color":"#F1AF15","italic":false,"text":"Корпус счётчика Гейгера"}}}}
execute as @s[tag=wasd.east] run summon item ~0.7 ~-0.7 ~ {Motion:[0.15,0.1,0.0],Item:{id:"minecraft:clock",count:1,components:{"minecraft:item_model":"custom/science/geiger_counter/parts/corpus","minecraft:custom_model_data":{strings:["corpus"]},"minecraft:custom_data":{Tags:["geiger_counter_corpus"]},"minecraft:custom_name":{"color":"#F1AF15","italic":false,"text":"Корпус счётчика Гейгера"}}}}
