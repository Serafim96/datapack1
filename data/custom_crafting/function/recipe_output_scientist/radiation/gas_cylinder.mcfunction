...
execute as @s[tag=wasd.north] run summon item ~ ~-0.7 ~-0.7 {Motion:[0.0,0.1,-0.15],Item:{id:"minecraft:warped_fungus_on_a_stick",count:1,components:{"minecraft:item_model":"custom/science/gas_cylinder","minecraft:custom_model_data":{strings:["empty"]},"minecraft:custom_data":{Tags:["gas_cylinder","empty"]},"minecraft:custom_name":{"color":"#A4A4A4","italic":false,"text":"Газовый баллон"},"minecraft:lore":[{"color":"#A4A4A4","text":"Пустой"}]}}}
execute as @s[tag=wasd.south] run summon item ~ ~-0.7 ~0.7 {Motion:[0.0,0.1,0.15],Item:{id:"minecraft:warped_fungus_on_a_stick",count:1,components:{"minecraft:item_model":"custom/science/gas_cylinder","minecraft:custom_model_data":{strings:["empty"]},"minecraft:custom_data":{Tags:["gas_cylinder","empty"]},"minecraft:custom_name":{"color":"#A4A4A4","italic":false,"text":"Газовый баллон"},"minecraft:lore":[{"color":"#A4A4A4","text":"Пустой"}]}}}
execute as @s[tag=wasd.east] run summon item ~0.7 ~-0.7 ~ {Motion:[0.15,0.1,0.0],Item:{id:"minecraft:warped_fungus_on_a_stick",count:1,components:{"minecraft:item_model":"custom/science/gas_cylinder","minecraft:custom_model_data":{strings:["empty"]},"minecraft:custom_data":{Tags:["gas_cylinder","empty"]},"minecraft:custom_name":{"color":"#A4A4A4","italic":false,"text":"Газовый баллон"},"minecraft:lore":[{"color":"#A4A4A4","text":"Пустой"}]}}}
