...
execute as @s[tag=wasd.north] run summon item ~ ~-0.7 ~-0.7 {Motion:[0.0,0.1,-0.15],Item:{id:"minecraft:leather_chestplate",count:1,components:{"minecraft:custom_name":{"italic":false,"text":"7-слойная кожаная куртка"},"minecraft:custom_data":{Tags:["radiation_leather_chestplate","7_layer"]},"minecraft:attribute_modifiers":[{id:"armor",type:"armor",amount:3.06,operation:"add_value",slot:"chest"}]}}}
execute as @s[tag=wasd.south] run summon item ~ ~-0.7 ~0.7 {Motion:[0.0,0.1,0.15],Item:{id:"minecraft:leather_chestplate",count:1,components:{"minecraft:custom_name":{"italic":false,"text":"7-слойная кожаная куртка"},"minecraft:custom_data":{Tags:["radiation_leather_chestplate","7_layer"]},"minecraft:attribute_modifiers":[{id:"armor",type:"armor",amount:3.06,operation:"add_value",slot:"chest"}]}}}
execute as @s[tag=wasd.east] run summon item ~0.7 ~-0.7 ~ {Motion:[0.15,0.1,0.0],Item:{id:"minecraft:leather_chestplate",count:1,components:{"minecraft:custom_name":{"italic":false,"text":"7-слойная кожаная куртка"},"minecraft:custom_data":{Tags:["radiation_leather_chestplate","7_layer"]},"minecraft:attribute_modifiers":[{id:"armor",type:"armor",amount:3.06,operation:"add_value",slot:"chest"}]}}}
