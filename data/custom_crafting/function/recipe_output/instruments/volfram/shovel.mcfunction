...
execute as @s[tag=wasd.north] run summon item ~ ~-0.7 ~-0.7 {Motion:[0.0,0.1,-0.15],Item:{id:"minecraft:netherite_shovel",count:1,components:{"minecraft:custom_name":"Вольфрамовая лопата","minecraft:custom_data":{Tags:["volfram_shovel"]},"minecraft:enchantments":{"minecraft:efficiency":4,"minecraft:unbreaking":3},"minecraft:tooltip_display":{hidden_components:["enchantments"]},"minecraft:attribute_modifiers":[{id:"1",type:"attack_damage",amount:9.5,operation:"add_value",slot:"mainhand"},{id:"2",type:"attack_speed",amount:2.2,operation:"add_value",slot:"mainhand"}],"minecraft:item_model":"custom/instrument/netherite/shovel","minecraft:custom_model_data":{strings:["volfram_shovel"]}}}}
