...
execute as @s[tag=wasd.north] run summon item ~ ~-0.7 ~-0.7 {Motion:[0.0,0.1,-0.15],Item:{id:"minecraft:netherite_shovel",count:1,components:{"minecraft:custom_name":"Титановая лопата","minecraft:custom_data":{Tags:["titan_shovel"]},"minecraft:enchantments":{"minecraft:unbreaking":1},"minecraft:tooltip_display":{hidden_components:["enchantments"]},"minecraft:attribute_modifiers":[{id:"1",type:"attack_damage",amount:7.5,operation:"add_value",slot:"mainhand"},{id:"2",type:"attack_speed",amount:1.4,operation:"add_value",slot:"mainhand"}],"minecraft:item_model":"custom/instrument/netherite/shovel","minecraft:custom_model_data":{strings:["titan_shovel"]}}}}
