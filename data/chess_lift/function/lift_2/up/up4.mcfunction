...
execute in minecraft:overworld run fill -15 -55 103 -15 -55 106 sea_lantern
execute in minecraft:overworld run fill -18 -55 106 -15 -55 106 sea_lantern
execute in minecraft:overworld run setblock -17 -55 104 black_concrete
execute in minecraft:overworld run setblock -16 -55 105 black_concrete
...
execute in minecraft:overworld as @e[tag=!lift_exclude,x=-18,dx=3,z=103,dz=3,y=-55,dy=0] at @s run tp @s ~ ~1 ~ ~ ~
