...
execute in minecraft:overworld run playsound minecraft:block.piston.contract block @a -16.0 -5 105.0 0.2 0
...
execute in minecraft:overworld as @e[tag=!lift_exclude,x=-18,dx=3,z=103,dz=3,y=-3,dy=0.1] at @s run tp @s ~ -3 ~ ~ ~
