...
execute in minecraft:overworld run fill -18 -51 103 -15 -51 106 air
execute in minecraft:overworld as @e[tag=!lift_exclude,x=-18,dx=3,z=103,dz=3,y=-51,dy=0.1] at @s run tp @s ~ -51 ~ ~ ~
