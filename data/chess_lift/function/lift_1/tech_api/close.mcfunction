...
schedule function chess_lift:set_usual_buttons 140t
schedule function chess_lift:lift_1/storage_operations/state/close 140t
schedule function chess_lift:lift_1/storage_operations/processing/off 140t
schedule function chess_lift:forceload/off 140t
schedule function chess_lift:storage_operations/total_mode/off 140t
