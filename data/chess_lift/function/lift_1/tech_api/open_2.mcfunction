...
execute if data storage chess_lift {ChessLiftTotalMode:0} run schedule function chess_lift:set_yellow_buttons 160t
schedule function chess_lift:lift_1/storage_operations/state/open 160t
schedule function chess_lift:lift_1/storage_operations/processing/off 160t
execute if data storage chess_lift {ChessLiftTotalMode:0} run schedule function chess_lift:forceload/off 160t