...
execute in overworld run fill 399 63 -11446 401 63 -11444 air
execute in overworld as @e[tag=!lift_exclude,x=399,dx=2,z=-11446,dz=2,y=63,dy=0.1] at @s run tp @s ~ 63 ~ ~ ~
