...
execute in overworld run fill 399 -34 -11446 401 -34 -11444 air
execute in overworld as @e[tag=!lift_exclude,x=399,dx=2,z=-11446,dz=2,y=-34,dy=0.1] at @s run tp @s ~ -34 ~ ~ ~
