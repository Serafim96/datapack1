...
execute in overworld run fill 399 0 -11446 401 0 -11444 air
execute in overworld as @e[tag=!lift_exclude,x=399,dx=2,z=-11446,dz=2,y=0,dy=0.1] at @s run tp @s ~ 0 ~ ~ ~
