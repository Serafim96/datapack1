...
execute in overworld run summon item_display 401 63.967 -11445 {NoGravity:1b,Silent:1b,Rotation:[0F,90F],Tags:["secret_admin_lift_upper_door","secret_admin_lift_upper_door_2"],item:{id:"minecraft:iron_bars",count:1}}
execute in overworld run summon item_display 400 63.967 -11445 {NoGravity:1b,Silent:1b,Rotation:[0F,90F],Tags:["secret_admin_lift_upper_door","secret_admin_lift_upper_door_2"],item:{id:"minecraft:iron_bars",count:1}}
execute in overworld run summon item_display 399 63.967 -11445 {NoGravity:1b,Silent:1b,Rotation:[0F,90F],Tags:["secret_admin_lift_upper_door","secret_admin_lift_upper_door_2"],item:{id:"minecraft:iron_bars",count:1}}
