...
execute in overworld as @e[type=!#myminecraft:popular_exclude_no_player,x=-11792,dx=23583,z=-11792,dz=23583,y=323,dy=10000] at @s if dimension minecraft:overworld run function custom_dimension:floating_islands/teleport/as_a
