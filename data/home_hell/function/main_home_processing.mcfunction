...
#kill @e[tag=!popular_exclude_no_player,type=minecraft:item,x=61,y=0,z=27,dx=-76,dy=127,dz=-41]
#kill @e[tag=!popular_exclude_no_player,type=minecraft:item,x=60,y=128,z=-14,dx=-76,dy=127,dz=70]

#### Dumbledore Teleport ####
particle minecraft:reverse_portal 14 29.5 4.99 0.2 0.7 0.0001 0 1
execute as @e[tag=!popular_exclude_no_player,type=!marker,x=14,dx=0,y=28,dy=2,z=5,dz=0] unless entity @s[tag=hell_dumbldore_teleport_door] at @s in minecraft:overworld run tp @s -565 29 2493 ~-90 ~

#### Gold Babylon Teleport ####
execute as @e[tag=!popular_exclude_no_player,type=!armor_stand,type=!marker,x=11,dx=3,y=47,dy=1,z=8,dz=0] at @s in minecraft:overworld run tp @s 422 64 -11436 -90 ~
...
execute as @e[tag=!popular_exclude_no_player,x=-5,dx=1,y=73,dy=3,z=-9] in minecraft:overworld run tp @s -421 19 2495 -90 ~
...
#Greenfield Museum
execute as @e[tag=!popular_exclude_no_player,x=3,dx=1,y=73,dy=3,z=-9] in minecraft:overworld run tp @s 3889 69 2721 90 ~
...
execute as @e[tag=!popular_exclude_no_player,x=11,dx=1,y=73,dy=3,z=-9] in minecraft:overworld run tp @s 3764.99 83 2213 0 ~
#green
...
#MineKea
execute as @e[tag=!popular_exclude_no_player,x=19,dx=1,y=73,dy=3,z=-9] in minecraft:overworld run tp @s 1506 69 1336.99 -90 ~
#yellow
...
#Sportfit
execute as @e[tag=!popular_exclude_no_player,x=27,dx=1,y=73,dy=3,z=-9] in minecraft:overworld run tp @s 2522 69 1169.99 90 ~
...
#Palace Hotel Roof
execute as @e[tag=!popular_exclude_no_player,x=35,dx=1,y=73,dy=3,z=-9] in minecraft:overworld run tp @s 3957 178 2673 180 ~
...
execute as @e[tag=!popular_exclude_no_player,x=35,dx=1,y=73,dy=3,z=18] in minecraft:overworld run tp @s 5544 151 1720.99 90 ~
particle dust{color:[1,1,1],scale:4} 36.01 75 18 0.5 1 0.1 0 2 force

#Macdonalds
execute as @e[tag=!popular_exclude_no_player,x=27,dx=1,y=73,dy=3,z=18] in minecraft:overworld run tp @s 1226.99 69 2975 0 ~
#Red
...
#wall cart
execute as @e[tag=!popular_exclude_no_player,x=19,dx=1,y=73,dy=3,z=18] in minecraft:overworld run tp @s 1566.99 69 2933 180 ~
...
execute as @e[tag=!popular_exclude_no_player,x=11,dx=1,y=73,dy=3,z=18] in minecraft:overworld run tp @s 3186 293 4839.99 90 ~
...
#Makuta Mini Village
execute as @e[tag=!popular_exclude_no_player,x=3,dx=1,y=73,dy=3,z=18] in minecraft:overworld run tp @s 1643.99 68 33 0 ~
...
#Шведское посольство
execute as @e[tag=!popular_exclude_no_player,x=-5,dx=1,y=73,dy=3,z=18] in minecraft:overworld run tp @s 5466 71.5 2910.99 90 ~
#White
