...
execute if entity @a[x=-4960,y=87,z=8755,dx=6,dy=1,dz=4,nbt={Inventory:[{id:"minecraft:clock",components:{"minecraft:custom_data":{Tags:["village_secret_botan_door_ticket"]}},Slot:-106b}]}] if data storage minecraft:village_artem {BotanGardenDoorOpened:0} run function village_artem:botan_garden/secret_door/open_door

execute unless entity @a[x=-4960,y=87,z=8755,dx=6,dy=1,dz=4,nbt={SelectedItem:{id:"minecraft:clock",components:{"minecraft:custom_data":{Tags:["village_secret_botan_door_ticket"]}}}}] unless entity @a[x=-4960,y=87,z=8755,dx=6,dy=1,dz=4,nbt={Inventory:[{id:"minecraft:clock",components:{"minecraft:custom_data":{Tags:["village_secret_botan_door_ticket"]}},Slot:-106b}]}] unless entity @a[x=-4957,dx=0,y=87,dy=1,z=8757,dz=0] if data storage minecraft:village_artem {BotanGardenDoorOpened:1} run function village_artem:botan_garden/secret_door/close_door
