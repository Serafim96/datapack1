...
execute as @a[x=-4969,dx=6,y=-47,dy=2,z=8756,dz=2] if entity @a[x=-4969,dx=6,y=-47,dy=2,z=8756,dz=2,nbt={SelectedItem:{components:{"minecraft:custom_data":{Tags:["village_secret_botan_door_ticket"]}}}}] run function village_artem:botan_garden/secret_door/laser/title/welcome
execute as @a[x=-4969,dx=6,y=-47,dy=2,z=8756,dz=2] if entity @a[x=-4969,dx=6,y=-47,dy=2,z=8756,dz=2,nbt={equipment:{offhand:{components:{"minecraft:custom_data":{Tags:["village_secret_botan_door_ticket"]}}}}}] run function village_artem:botan_garden/secret_door/laser/title/welcome

execute as @a[x=-4969,dx=6,y=-47,dy=2,z=8756,dz=2] unless entity @a[x=-4969,dx=6,y=-47,dy=2,z=8756,dz=2,nbt={SelectedItem:{components:{"minecraft:custom_data":{Tags:["village_secret_botan_door_ticket"]}}}}] unless entity @a[x=-4969,dx=6,y=-47,dy=2,z=8756,dz=2,nbt={equipment:{offhand:{components:{"minecraft:custom_data":{Tags:["village_secret_botan_door_ticket"]}}}}}] run function village_artem:botan_garden/secret_door/laser/title/need_ticket