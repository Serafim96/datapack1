...
execute if data storage minecraft:village_artem {CentralGateSecurityProcessingOn:1} if data storage minecraft:village_artem {CentralGateSecurityOn:1} if data storage minecraft:village_artem {CentralGateSecurityTurnOffScheduled:0} unless entity @e[predicate=!village_artem:central_gates/security/has_custom_data_tag_village_artem_security,tag=!village_artem_security,type=!player,type=!horse,type=!donkey,type=!minecraft:marker,type=!minecraft:armor_stand,type=!minecraft:painting,type=!item,type=!item_frame,type=!glow_item_frame,x=-5187,dx=19,y=64,dy=6,z=8536,dz=1] run function village_artem:central_gates/security/api/schedule_turn_off
