...
#тегаем стрелы
execute if data storage minecraft:village_artem {CentralGateSecurityProcessingOn:1} run tag @e[x=-5187,dx=19,y=64,dy=6,z=8534,dz=4,type=arrow] add village_artem_security
execute if data storage minecraft:village_artem {CentralGateSecurityProcessingOn:1} run execute as @e[tag=village_artem_security,type=arrow] run data merge entity @s {pickup:0b}
...
# Детектор охраны
execute if data storage minecraft:village_artem {CentralGateSecurityProcessingOn:0} if data storage minecraft:village_artem {CentralGateSecurityOn:0} if entity @e[tag=!village_artem_security,type=!player,type=!horse,type=!donkey,type=!minecraft:marker,type=!minecraft:armor_stand,type=!minecraft:painting,type=!item,type=!item_frame,type=!glow_item_frame,x=-5187,dx=19,y=64,dy=6,z=8536,dz=1] run function village_artem:central_gates/security/api/turn_on
execute if data storage minecraft:village_artem {CentralGateSecurityProcessingOn:1} if data storage minecraft:village_artem {CentralGateSecurityOn:1} unless entity @e[tag=!village_artem_security,type=!player,type=!horse,type=!donkey,type=!minecraft:marker,type=!minecraft:armor_stand,type=!minecraft:painting,type=!item,type=!item_frame,type=!glow_item_frame,x=-5187,dx=19,y=64,dy=6,z=8536,dz=1] run function village_artem:central_gates/security/api/turn_off