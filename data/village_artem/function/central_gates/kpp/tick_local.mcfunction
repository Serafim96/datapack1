...
execute in minecraft:overworld if data storage minecraft:village_artem {MainGateState:1} if entity @a[gamemode=!spectator,x=-5195,dx=35,y=64,dy=6,z=8513,dz=24] if data storage village_artem {MainTicketOn:1} run function village_artem:central_gates/kpp/storage_operations/set_main_gate_state_2
...
execute in minecraft:overworld unless entity @a[gamemode=!spectator,x=-5195,dx=35,y=64,dy=6,z=8513,dz=24] if data storage minecraft:village_artem {MainGateState:2} run function village_artem:central_gates/kpp/storage_operations/set_main_gate_state_1
