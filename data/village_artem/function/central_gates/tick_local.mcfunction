...
# Если реактор выключен, ничего не делаем
execute if data storage village_artem {nuclear_reactor:{powered:0}} run return run function village_artem:central_gates/readcor_disabled
