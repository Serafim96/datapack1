...
# [WAS] data merge entity @e[type=block_display,limit=1,tag=village_artem_sawmill_main_door] {start_interpolation:0,interpolation_duration:20,transformation:{left_rotation:[0f,0f,0f,1f]}}
...
data merge entity @e[limit=1,tag=village_artem_sawmill_main_door,type=block_display] {start_interpolation:0,interpolation_duration:20,transformation:{left_rotation:[0f,0f,0f,1f]}}
