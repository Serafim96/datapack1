...
execute in overworld run fill -5081 206 9097 -5079 206 9099 air
execute in overworld as @e[tag=!lift_exclude,x=-5081,dx=2,z=9097,dz=2,y=206,dy=0.1] at @s run tp @s ~ 206 ~ ~ ~
