...
execute in overworld run fill -4981 146 9049 -4979 146 9051 air
execute in overworld as @e[tag=!lift_exclude,x=-4981,dx=2,z=9049,dz=2,y=146,dy=0.1] at @s run tp @s ~ 146 ~ ~ ~
