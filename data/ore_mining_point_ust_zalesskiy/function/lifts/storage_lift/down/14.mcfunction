...
execute in overworld run fill -4034 13 4632 -4029 13 4634 air
execute in overworld as @e[tag=!lift_exclude,x=-4034,dx=5,z=4632,dz=2,y=13,dy=0.1] at @s run tp @s ~ 13 ~ ~ ~
