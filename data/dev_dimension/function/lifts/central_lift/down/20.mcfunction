...
execute in dev_dimension:dev_dimension run fill -3 381 -3 3 381 3 air
execute in dev_dimension:dev_dimension as @e[tag=!lift_exclude,x=-3,dx=6,z=-3,dz=6,y=381,dy=0.1] at @s run tp @s ~ 381 ~ ~ ~
