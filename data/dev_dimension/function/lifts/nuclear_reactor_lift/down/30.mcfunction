...
execute in dev_dimension:dev_dimension run fill -65 82 56 -64 82 58 air
execute in dev_dimension:dev_dimension as @e[tag=!lift_exclude,x=-65,dx=1,z=56,dz=2,y=82,dy=0.1] at @s run tp @s ~ 82 ~ ~ ~
