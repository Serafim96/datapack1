execute in dev_dimension:dev_dimension run function dev_dimension:overworld_portal/tick
execute in dev_dimension:dev_dimension run function dev_dimension:gamerules_read_overworld
